...
## 2402. Meeting Rooms III
    ...
    meetings[i] = [starti, endi] means that 
...
class MeetingOrganiser:

    def __init__(self, n, meetings):
        self.rooms = dict({i, None} for i in range(n)) # Use the fact that if the room is occupied there will be a number otherwie it will be none
        self.num_meetings = [0 for _ in range(n)]
        self.meetings = meetings

    def allocate_room(self, mtg):
        if None in self.rooms.values():
